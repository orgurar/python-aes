#!/usr/bin/env python3
'''
This is an exercise in AES encryption,
implemented in pure Python (no external libraries needed).

The following code was written while solving CryptoHack (https://www.cryptohack.org/) challenges.
